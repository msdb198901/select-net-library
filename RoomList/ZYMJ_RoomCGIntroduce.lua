local ASMJ_RoomCGIntroduce = class("ASMJ_RoomCGIntroduce", function() return cc.Layer:create() end)

-----------------------------------------function OnClickEvent-------------------
function ASMJ_RoomCGIntroduce:OnClickEvent(clickcmd)
    print("ASMJ_RoomCGIntroduce:OnClickEvent " .. clickcmd:getnTag())
...
--init()
function ASMJ_RoomCGIntroduce:init(iType)
    print("ASMJ_RoomCGIntroduce:init")
    ...
    self.m_roomIntroduceBg = cc.Sprite:create(string.format("316_room_information_%d.png", iType))
    assert(self.m_roomIntroduceBg, "error Index for CGRoom Introduce")
    self.m_roomIntroduceBg:setPosition(285, 209)
    self.m_pBoard:addChild(self.m_roomIntroduceBg)

    self.m_roomTitle = cc.Sprite:create(string.format("316_room_title_name_%d.png", iType))
...
--ctor()
function ASMJ_RoomCGIntroduce:ctor(iType)
    print("ASMJ_RoomCGIntroduce:ctor")
    self:init(iType)
...
--create( ... )
function ASMJ_RoomCGIntroduce_create(iType)
    print("ASMJ_RoomCGIntroduce_create")
    local layer = ASMJ_RoomCGIntroduce.new(iType)
    return layer
end

--onEnter()
function ASMJ_RoomCGIntroduce:onEnter()
    print("ASMJ_RoomCGIntroduce:onEnter")
...
--onExit()
function ASMJ_RoomCGIntroduce:onExit()
    print("ASMJ_RoomCGIntroduce:onExit")
end

--touch begin
function ASMJ_RoomCGIntroduce:onTouchBegan(touch, event)
...
--touch end
function ASMJ_RoomCGIntroduce:onTouchEnded(touch, event)

end

--OnKeyBackEvent
function ASMJ_RoomCGIntroduce:OnKeyBackEvent()
